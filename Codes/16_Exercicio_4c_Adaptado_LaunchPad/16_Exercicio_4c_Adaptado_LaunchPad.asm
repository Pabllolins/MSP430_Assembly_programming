...
testaS4		bit.b 	#010h,&P1IN  //testa o P1.4(S4) 00010000b
		jnz 	retorna1 //Enquanto o botão estiver pressionado, ficará nesse laço "Debouncing"
...
testaS4_2	bit.b 	#010h,&P1IN ; //testa o P1.4(S4) 00010000b
		jz 	Espera_1; //Enquanto o botão estiver pressionado, ficará nesse laço "Debouncing"
retorna1	bic.w 	#00001h,&TACTL //Limpa a flag de interrupção do timerA
...
testaS2		bit.b 	#008h,&P1IN // testa o P1.3(S2) 00001000b
		jnz 	retorna2 //Enquanto o botão estiver pressionado, ficará nesse laço "Debouncing"
...
testaS2_2	bit.b 	#008h,&P1IN // testa o P1.3(S2) 00001000b
		jz 	Espera_2; //Enquanto o botão estiver pressionado, ficará nesse laço "Debouncing"
...
retorna2	bic.b 	#008h,&P1IFG //Limpa a flag de interrupção P1.3(S2)
		reti //Retorno de interrupção						
;------------------------------------------------------------------------------
